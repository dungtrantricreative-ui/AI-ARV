...
{{
  "intent": "set_bgm" | "start_render" | "terminal_cmd" | "stop_program" | "chat" | "unknown",
  "params": {{
...
Lưu ý quan trọng:
1. Nếu người dùng muốn dừng chương trình, thoát, hoặc kết thúc, hãy đặt intent là "stop_program".
2. Nếu là yêu cầu chạy lệnh máy tính, hãy đặt intent là "terminal_cmd".
