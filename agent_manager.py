...
{{
  ...
  "params": {{
    ...
    "video_path": "đường dẫn file video hoặc link URL nếu người dùng cung cấp",
...
Lưu ý quan trọng:
1. Nếu người dùng cung cấp đường dẫn video hoặc link video, hãy đặt intent là "process_video" và trích xuất đường dẫn vào "video_path".
2. Nếu người dùng muốn bắt đầu dựng phim, render, hoặc làm video, hãy đặt intent là "start_render".
3. Nếu người dùng muốn dừng chương trình, thoát, hoặc kết thúc, hãy đặt intent là "stop_program".
